      ...
      .then(admin => {
        if (admin) {
          ...
          PasswordResets.create({
            ...
            return res.json({
              message:
                "Password reset link has been send to your email with further instructions"
            });
          });
        } else {
          return res.json({
                ...
                if (user) {
                  ...
                  user
                    ...
                    .then(() => {
                      return res.json({
                        message:
                          "Password reset successful. Login in with your new password"
                      });
                    })
                    .catch(err => {
                      res.status(500).json({
                  ...
                  return res.json({
                    message:
                      "Password reset failed. Try resending another password reset link"
                  });
                }
              })
              .catch(err => {
